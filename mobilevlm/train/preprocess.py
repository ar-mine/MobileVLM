...
from mobilevlm.constants import (DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN,
                                 IGNORE_INDEX)
local_rank = None
...
class ModelArguments:
    ...
    segment_encoder_path: Optional[str] = field(default=None)
    segment_output_dim: Optional[int] = field(default=256)
    mm_vision_select_layer: Optional[int] = field(default=-1)   # default to the last layer
    pretrain_mm_mlp_adapter: Optional[str] = field(default=None)
    mm_projector_type: Optional[str] = field(default='linear')
    mm_use_im_start_end: bool = field(default=False)
    mm_use_im_patch_token: bool = field(default=True)
    mm_use_seg: bool = field(default=False, metadata={"help": "Whether adding [SEG] token into tokenizer."})
...
class DataArguments:
    ...
    segment_label: bool = field(default=False,
                                metadata={"help": "Whether the dataset should be processed with segmentation mask."})
...
IMG_SIZE = 1024
def preprocess_sam(x: torch.Tensor,
